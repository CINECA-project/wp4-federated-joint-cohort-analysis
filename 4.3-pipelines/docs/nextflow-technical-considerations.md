...
* You can run `bash nextflow/launch.sh [flags]`, but it has to be done on the same machine where you compiled it, otherwise the different baked-in paths will not match.
